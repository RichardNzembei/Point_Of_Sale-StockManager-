  ...
  <div class="container mx-auto py-4 sm:py-6 md:py-8 px-4 sm:px-6 max-w-full sm:max-w-4xl md:max-w-6xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
      ...
      <div class="bg-white p-4 sm:p-6 rounded-2xl shadow-md border border-rose-100">
        ...
        <div v-if="salesStore.loading" class="space-y-3 sm:space-y-4">
          <div v-for="n in 3" :key="n" class="bg-rose-50 p-3 sm:p-4 rounded-lg animate-pulse">
            <div class="h-3 sm:h-4 bg-rose-100 rounded-full w-3/4 mb-2"></div>
        ...
        <ul v-else class="space-y-2 sm:space-y-3 max-h-[50vh] sm:max-h-[60vh] overflow-y-auto">
          <li v-for="sale in salesItems" :key="sale.id"
            class="group bg-white p-3 sm:p-4 rounded-xl border border-rose-100 hover:border-rose-200 hover:shadow-sm transition-all duration-200 flex justify-between items-center">
            <div>
      ...
      <div class="bg-white p-4 sm:p-6 rounded-2xl shadow-md border border-rose-100">
        ...
        <div v-if="stockStore.loading" class="space-y-3 sm:space-y-4">
          <div v-for="n in 2" :key="n" class="bg-rose-50 p-3 sm:p-4 rounded-lg animate-pulse">
            <div class="h-4 sm:h-5 bg-rose-100 rounded-full w-1/3 mb-2 sm:mb-3"></div>
            <div class="space-y-2">
        ...
        <ul v-else class="space-y-3 sm:space-y-4 max-h-[50vh] sm:max-h-[60vh] overflow-y-auto">
          <li v-for="(subtypes, productType) in filteredStock" :key="productType"
            class="bg-rose-50 p-3 sm:p-4 rounded-xl border border-rose-100 hover:border-rose-200 transition-all duration-200">
            <!-- Product Type Header -->
    ...
    <div v-if="showEditModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
      <div class="bg-white p-4 sm:p-6 rounded-2xl shadow-lg max-w-full w-full sm:max-w-md">
